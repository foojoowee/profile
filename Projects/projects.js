...
window.addEventListener("scroll", function(){
    ...
    console.log("image2pos is " + fProject1Position)
    console.log("image1pos is " + fProject2Position)
    ...
    console.log("otherProj1 is " + oProject1Position)
    console.log("otherProji2 is " + oProject2Position)
})
